...
public abstract class ServiceLoader {
    ...
    public static <T> T singleton(Class<T> serviceType, ClassLoader classLoader, Supplier<T> defaultSupplier) {
        ...
        while (iterator.hasNext()) {
            if (service == null) {
                ...
                throw new IllegalStateException("More than one service found for " + serviceName + "!");
            }
        }
        if (service == null) {
